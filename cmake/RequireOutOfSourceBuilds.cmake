...
function(require_out_of_source_build)
    # Converts a file path to CMake's preferred path format - it normalizes the path separators (e.g., converts backslashes \ to forward slashes / on Windows) - and store the normalized path in the variable `LOC_PATH`.
    file(TO_CMAKE_PATH
        "${PROJECT_BINARY_DIR}/CMakeLists.txt" LOC_PATH
    )
